...
TOKEN = os.environ.get("8748775050:AAFHcDI6JlYGmCKTiIoUe17fKGOG80KsaXA") PORT = int(os.environ.get("PORT", 8080)) WEBHOOK_URL = os.environ.get("WEBHOOK_URL")  # https://ваш-сайт.railway.app
